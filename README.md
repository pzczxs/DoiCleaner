...
Various DOI errors of cited references in the WoS database are deeply analyzed and a cleaning approach is put forward to alleviate the extent of DOI errors of cited references by Xu et al. (2019). This tool implements the cleaning approach. Please refer to Xu et al. (2019) for more details. 
## 2. License
